;(function(){
	...
	angular.module('SpotifyApp')
		...
		MainController.$inject = ['artists'];
		function MainController( artists ){
			var vm = this;
			vm.searchArtistActivated = false;
			vm.artist = {
				name: 'Maroon',
				limit: 20
			}
			vm.searchArtist = function(){
				vm.searchArtistActivated = true;
				if(vm.artist.name && vm.artist.limit > 0){
					artists.getWithLimit(vm.artist.name, vm.artist.limit)
